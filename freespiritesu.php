 ...
 * 
 * 
 *    Copyright FreeSpirit ESU  (email: richard@freespiritesu.org.uk)
 * 
 ...
 * This action is documented in includes/class-freespiritesu-activator.php
 */
function activate_FreeSpiritESU() {
    require_once plugin_dir_path( __FILE__ ) . 'includes/class-freespiritesu-activator.php';
    Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-freespiritesu-deactivator.php
 */
function deactivate_FreeSpiritESU() {
    require_once plugin_dir_path( __FILE__ ) . 'includes/class-freespiritesu-deactivator.php';
    Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_FreeSpiritESU' );
register_deactivation_hook( __FILE__, 'deactivate_FreeSpiritESU' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-freespiritesu.php';
 ...
 * @since    1.0.0
 */
function run_FreeSpiritESU() {

    $plugin = new FreeSpiritESU();
    $plugin->run();
